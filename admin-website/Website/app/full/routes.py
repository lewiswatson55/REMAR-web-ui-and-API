from app.full import blueprint
...
def full():
    ...
    return render_template('full.html', docCount=dbOverview.json()['doc_count'], shortCount=shortCount, longCount=longCount, userCount=userCount, record=entries, crabState=stateAns, crabCounty=countyAns)
