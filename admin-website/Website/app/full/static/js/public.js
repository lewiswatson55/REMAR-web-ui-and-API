...
function makeRanges()
{
	...
	var ranges = {};
	ranges["Todos os anos"] = ["01/11/2015", "31/12/" + currentYear];
...
function prettifyCalendar(){
	...
	$('.daterangepicker_input').each(function(index){
		var html = '<div style="margin-top:10px;" class="input-prepend input-group"><span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span><input type="text" style="width: 200px" id="manualPick'+index+'" class="form-control" value="01/11/2015" /></div>';
		$(this).html(html);
	});
